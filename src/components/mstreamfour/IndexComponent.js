...
class IndexComponent extends Component {
  ...
  render() {
    ...
    const { masonarystreamv4: componentConfig } = this.props.config;
    return (
      <RegularLayout
...
IndexComponent.propTypes = {
  ...
  config: PropTypes.shape({
    masonarystreamv4: PropTypes.shape({
